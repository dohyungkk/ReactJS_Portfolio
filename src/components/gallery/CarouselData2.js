...
export const images = [
    ...
    {title: "Weather App", subtitle: "Weather App gets a weather update using API from openweathermap.org. This is one of my first Node JS project to help myself to understand request and response.", img: m}
];